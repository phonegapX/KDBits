...
BEGIN_MESSAGE_MAP(CTextProgressCtrl, CProgressCtrl)
    ...
    ON_WM_SIZE()
    //}}AFX_MSG_MAP
    ON_MESSAGE(WM_SETTEXT, (LRESULT (__thiscall CWnd::* )(WPARAM,LPARAM))OnSetText)
    ON_MESSAGE(WM_GETTEXT, (LRESULT (__thiscall CWnd::* )(WPARAM,LPARAM))OnGetText)
END_MESSAGE_MAP()
...
LRESULT CTextProgressCtrl::OnGetText(UINT cchTextMax, LPTSTR szText)
{
    ...
    if (!_tcsncpy(szText, m_strText, cchTextMax))
        ...
        return __GetMin(cchTextMax, (UINT) m_strText.GetLength());
}
